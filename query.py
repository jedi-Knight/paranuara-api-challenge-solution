...
class QueryBuilder(object):
    ...
    def multi_value_match_query(self, query_column, values_list):
        ...
        return df[query_column].isin( values_list )
    ...
    def multi_column_match_query(self, *col_val_tuple):
        ...
        return_series = (df['index_x'] >= 0)    #get a Pandas Series object of size equals to the dataframe size and all True values
